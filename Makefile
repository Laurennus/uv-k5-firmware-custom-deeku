...
ifeq ($(NOAA_AS_PMR446),1)
	CFLAGS  += -DNOAA_AS_PMR446
endif
ifeq ($(ENABLE_VOICE),1)
...
ifeq ($(ENABLE_CUSTOM_MENU_DEEKU),1)
	CFLAGS  += -DENABLE_CUSTOM_MENU_DEEKU
endif
ifeq ($(ENABLE_FEAT_F4HWN),1)
...
ifneq ($(filter $(DISABLE_FEAT_ROPS_FLASH),1 2),)
	CFLAGS  += -DDISABLE_FEAT_ROPS_FLASH=$(DISABLE_FEAT_ROPS_FLASH)
endif
